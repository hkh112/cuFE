...
// This function is added for extract values to IPFE library.
// 이 함수는 값을 IPFE 라이브러리로 추출하기 위해 만들어졌습니다.
double svm_predict_values_extracted(const svm_model* model, const svm_node* x, double* dec_values)
{
	int i;
...
// This function is modified for extract values to IPFE library.
// 이 함수는 값을 IPFE 라이브러리로 추출하기 위해 수정되었습니다.
double svm_predict(const svm_model *model, const svm_node *x)
{
	...
	double pred_result = svm_predict_values_extracted(model, x, dec_values);
	free(dec_values);
	return pred_result;
}
